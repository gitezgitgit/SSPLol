...
NameLabel.Text = "Secret Service Panel"
...
Frame_4.BackgroundColor3 = Color3.fromRGB(38, 37, 38)
Frame_4.BorderSizePixel = 0
Frame_4.Position = UDim2.new(-0.000358005753, 0, 0.152203158, 0)
Frame_4.Size = UDim2.new(0, 98, 0, 197)

packages.Name = "packages"
packages.Parent = Frame
packages.BackgroundColor3 = Color3.fromRGB(53, 52, 53)
packages.BorderSizePixel = 0
packages.Position = UDim2.new(0.00517658424, 0, 0.178197145, 0)
packages.Size = UDim2.new(0, 95, 0, 28)
...
CreateScript("Dex Explorer",function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/infyiff/backup/main/dex.lua"))()
end)

CreateScript("LuaMayG*y v2",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/sigmaballs4141/asd/refs/heads/main/LuaMayGayV2.txt"))()
end)

CreateScript("Mr.Bean Admin",function()
 loadstring(game:HttpGet("https://raw.githubusercontent.com/Test4267/mrbean/refs/heads/main/hh"))() -- Red all
end)

CreateScript("MLG 2520 Gun",function()
loadstring(game:HttpGet("https://rawscripts.net/raw/Client-Replication-the-ss-loadstring-script-27393"))() -- Hd brickspam
end)

CreateScript("Red Sword PicAxe (not found)",function()
loadstring(game:HttpGet(("https://paste.website/p/67e65cf2-1afe-4467-b04c-5ec95566807c.txt"), true))() -- bread
end)

CreateScript("Grab knife v3",function()
loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-grab-knife-v3-9232"))() -- Bat gui
end)

CreateScript("Titan",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/TEST19983/Reslasjd/refs/heads/main/attac"))() -- Box admin
end)

CreateScript("BombVest v2",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/ProBypasserHax1/Ussjzbwusbdlq/refs/heads/main/Luafile33Xc3eww"))() -- WeAreSkids
end)

CreateScript("c00lgui",function()
loadstring(game:GetObjects('rbxassetid://473373681')[1].Source)()
end)

CreateScript("Ro-Xploit v6",function()
